import 'package:p2/match_picture/cmplt1.dart';
import 'package:p2/match_picture/cmplt2.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';

import '../prectice/uipage.dart';
import 'cmplt3.dart';
...
class _homeState extends State<home> {
  ...
  get_pref() async {
    firste.prefs = await SharedPreferences.getInstance();
    level_no = firste.prefs!.getInt("levelno") ?? 0;
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return (l_no1 <= level_no)?InkWell(
                                        ...
                                        child: Container(
                                            ...
                                            child:  Wrap(
                                              children: [
                                                (l_no1<level_no) ? Text("LEVEL ${l_no} - ${firste.prefs!.getInt("level_time${l_no1}") ?? ""}",style: TextStyle(fontSize: 20,color: Colors.white))
